<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"E:\www\cms\public/../application/admin\view\admin_user\authList.html";i:1528798583;s:50:"E:\www\cms\application\admin\view\public\base.html";i:1528798765;s:52:"E:\www\cms\application\admin\view\public\header.html";i:1514946050;s:52:"E:\www\cms\application\admin\view\public\footer.html";i:1514946050;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo url('admin/index/index'); ?>" class="logo">
      ...
      <span class="logo-lg"><b>后台通用</b>管理系统</span>
    </a>
                ...
                <tbody>
                   <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td>
                                  <!--<button type="button" class="btn btn-success">添加子菜单</button> <button type="button" class="btn btn-primary">编辑</button> <button type="button" class="btn btn-danger" onClick="delcfm('<?php echo url('admin/menu/del',['id' => $vo['id']]); ?>','<?php echo $vo['title']; ?>')">删除</button>-->
                                    <button type="button" onclick="lotus_show('编辑菜单',
                                    'show_edit_menu.html?id=<?php echo $vo['id']; ?>',500,460)" class="btn btn-xs btn-success">编辑
                                    </button>
                                    <button type="button" onClick="deleteAuthRule(<?php echo $vo['id']; ?>)" class="btn  btn-danger btn-xs">删除</button>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
